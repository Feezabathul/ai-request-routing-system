  ...
  return (
    <section className="min-h-screen flex flex-col lg:flex-row bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100">
      ...
      <div className="flex flex-1 items-center justify-center p-6">
        <div className="w-full max-w-md bg-white bg-opacity-30 backdrop-blur-xl rounded-2xl shadow-2xl p-8 sm:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-300 bg-white bg-opacity-60 backdrop-blur-sm px-4 py-2 text-sm text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors"
              />
            </div>
